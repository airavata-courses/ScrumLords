...
class Session(TimeStampedModel, SoftDeletableModel):
    ...
    alternate_names = models.CharField(max_length=500, null=True)
    latitude = models.CharField(max_length=15, null=False)
    longitude = models.CharField(max_length=15, null=False)
    ...
    elevation = models.CharField(max_length=12, null=True)
